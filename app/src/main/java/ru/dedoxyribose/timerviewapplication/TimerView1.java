...
public class TimerView1 extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            Drawable indicatorIcon = a.getDrawable(R.styleable.TimerView_playIcon);
            ...
            mPoints = a.getInteger(R.styleable.TimerView_points, mPoints);
            //убрал сам mMin = a.getInteger(R.styleable.TimerView_min, mMin);
            //убрал сам mMax = a.getInteger(R.styleable.TimerView_max, mMax);
            mStep = a.getInteger(R.styleable.TimerView_step, mStep);
            ...
            //mTextSize = (int) a.getDimension(R.styleable.TimerView_bitextSize, mTextSize);
            //textColor = a.getColor(R.styleable.TimerView_textColor, textColor);

            mClockwise = a.getBoolean(R.styleable.TimerView_clockwise,
                    mClockwise);
...
//				System.out.printf("-- %d, %d, %f\n", progress, mPoints, mProgressSweep);
    ...
    public interface OnTimerViewChangeListener {
         ...
         */
        void onPointsChanged(TimerView1 TimerView, int points, boolean fromUser);

        void onStartTrackingTouch(TimerView1 TimerView);

        void onStopTrackingTouch(TimerView1 TimerView);
    }
